...
<html lang="en">
<head>
    <title>Code coverage report for src/test/renderer.test.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\index.html">All files</a> / <a href="index.html">src/test</a> renderer.test.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Application, ProjectReflection } from '..';
...
&nbsp;
        if (aSrc !== bSrc) {
            const err: any = <span class="cstat-no" title="statement not covered" >new Error(`File contents of "${file}" differ.`);</span>
<span class="cstat-no" title="statement not covered" >            err.expected = aSrc;</span>
<span class="cstat-no" title="statement not covered" >            err.actual = bSrc;</span>
<span class="cstat-no" title="statement not covered" >            err.showDiff = true;</span>
