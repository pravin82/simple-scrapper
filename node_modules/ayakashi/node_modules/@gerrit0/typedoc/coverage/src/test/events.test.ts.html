...
<html lang="en">
<head>
    <title>Code coverage report for src/test/events.test.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\index.html">All files</a> / <a href="index.html">src/test</a> events.test.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">97.15% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>545/561</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>539/553</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L842'></a><a href='#L842'>842</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Backbone.js 1.2.3
...
&nbsp;
        ...
        b.trigger('anything');
&nbsp;
        a.listenTo(b, 'all', <span class="fstat-no" title="function not covered" >function () {</span>
...
&nbsp;
    it('listenToOnce and stopListening', function () {
        ...
        b.trigger('anything');
        b.trigger('anything');
        a.listenToOnce(b, 'all', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            Assert(false);</span>
        });
        a.stopListening();
        b.trigger('anything');
...
&nbsp;
    it('listenTo and stopListening with event maps', function () {
        ...
        b.trigger('change');
        a.listenTo(b, {
            change: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >                Assert(false);</span>
            }
        });
        a.stopListening();
...
&nbsp;
    it('listenTo yourself cleans yourself up with stopListening', function () {
        ...
        e.trigger('foo');
&nbsp;
        e.listenTo(e, 'foo', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            Assert(false);</span>
        });
        e.stopListening();
        e.trigger('foo');
...
&nbsp;
    it('stopListening cleans up references', function () {
        ...
        const fn = <span class="fstat-no" title="function not covered" >function () {}</span>;
        b.on('event', fn);
&nbsp;
...
&nbsp;
        ...
        b.trigger('anything');
&nbsp;
        a.listenTo(b, 'other', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            Assert(false);</span>
        });
...
&nbsp;
    it('listenToOnce with event maps cleans up references', function () {
        ...
        a.listenToOnce(b, {
            ...
            two: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >                Assert(false);</span>
            }
        });
        b.trigger('one');
...
&nbsp;
    it('remove all events for a specific context', function () {
        ...
        obj.on('x y all', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            Assert(false);</span>
        }, obj);
...
&nbsp;
    it('remove all events for a specific callback', function () {
        ...
        const fail = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            Assert(false);</span>
        };
...
&nbsp;
    it('#1310 - off does not skip consecutive events', function () {
        const obj = new Events();
        obj.on('event', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            Assert(false);</span>
        }, obj);
        obj.on('event', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            Assert(false);</span>
...
&nbsp;
    it('once with off', function () {
        const obj = new Events();
        const f = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            Assert(false);</span>
        };
&nbsp;
        obj.once('event', f);
...
&nbsp;
    it('once with off only by context', function () {
        const context = {};
        const obj = new Events();
        obj.once('event', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >            Assert(false);</span>
        }, context);
...
&nbsp;
    it('stops propagation', function() {
        ...
        events.on('myEvent', <span class="fstat-no" title="function not covered" >function(e</span>) { <span class="cstat-no" title="statement not covered" >count++; <span class="cstat-no" title="statement not covered" ></span>Assert(false); </span>});
        events.trigger(event);
        Assert.equal(count, 1);
    });
&nbsp;
