...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/output/plugins/TocPlugin.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/output/plugins</a> TocPlugin.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Reflection, ReflectionKind, ProjectReflection, DeclarationReflection } from '../../models/reflections/index';
...
&nbsp;
    ...
    static buildToc(model: Reflection, trail: Reflection[], parent: NavigationItem, restriction?: string[]) {
        ...
        const children = model['children'] || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
&nbsp;
        if (index &lt; trail.length - 1 &amp;&amp; children.length &gt; 40) {
            const child = <span class="cstat-no" title="statement not covered" >trail[index + 1];</span>
            const item = <span class="cstat-no" title="statement not covered" >NavigationItem.create(child, parent, true);</span>
<span class="cstat-no" title="statement not covered" >            item.isInPath  = true;</span>
<span class="cstat-no" title="statement not covered" >            item.isCurrent = false;</span>
<span class="cstat-no" title="statement not covered" >            TocPlugin.buildToc(child, trail, item);</span>
        } else {
            children.forEach((child: DeclarationReflection) =&gt; {
&nbsp;
                if (restriction &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >restriction.length &gt; 0 </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >!restriction.includes(child.name))</span> {
<span class="cstat-no" title="statement not covered" >                    return;</span>
                }
&nbsp;
