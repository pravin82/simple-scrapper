...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/output/plugins/AssetsPlugin.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/output/plugins</a> AssetsPlugin.ts
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >            fromDefault = undefined;</span>
        }
&nbsp;
        const from = Path.join(this.owner.theme!.basePath, 'assets');
        if (from !== fromDefault &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >FS.existsSync(from))</span> {
<span class="cstat-no" title="statement not covered" >            FS.copySync(from, to);</span>
        }
    }
}
&nbsp;</pre></td></tr>
