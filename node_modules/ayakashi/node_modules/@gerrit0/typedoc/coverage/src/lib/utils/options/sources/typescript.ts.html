...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/utils/options/sources/typescript.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/utils/options/sources</a> typescript.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
    private addTSOption(option: _ts.CommandLineOption) {
        const param: DeclarationOption = {
            ...
            help:      option.description ? option.description.key : <span class="branch-1 cbranch-no" title="branch not covered" >'',</span>
...
&nbsp;
        switch (option.type) {
            ...
            default:
                ...
                if (option['error']) {
                    const error = <span class="cstat-no" title="statement not covered" >_ts.createCompilerDiagnostic(option['error']);</span>
<span class="cstat-no" title="statement not covered" >                    param.mapError = ts.flattenDiagnosticMessageText(error.messageText, ', ');</span>
                }
        }
&nbsp;
