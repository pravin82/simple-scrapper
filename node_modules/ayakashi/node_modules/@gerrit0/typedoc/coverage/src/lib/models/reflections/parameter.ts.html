...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/models/reflections/parameter.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/models/reflections</a> parameter.ts
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >        return super.toString() + (this.type ? ':' + this.type.toString() :  '');</span>
    }
}
&nbsp;</pre></td></tr>
</table></pre>
