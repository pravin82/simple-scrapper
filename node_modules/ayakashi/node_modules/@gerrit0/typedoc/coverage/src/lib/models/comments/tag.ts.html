...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/models/comments/tag.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/models/comments</a> tag.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
        if (this.paramName) {
<span class="cstat-no" title="statement not covered" >            result.param = this.paramName;</span>
        }
&nbsp;
        return result;
    }
