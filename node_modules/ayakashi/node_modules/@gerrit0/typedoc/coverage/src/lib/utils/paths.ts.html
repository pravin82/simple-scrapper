...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/utils/paths.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\index.html">All files</a> / <a href="index.html">src/lib/utils</a> paths.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
    if (unix) { <span class="cstat-no" title="statement not covered" >pattern = pattern.replace(/[\\]/g, '/').replace(/^\w:/, ''); </span>}
&nbsp;
