...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/models/types/type-parameter.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/models/types</a> type-parameter.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
        if (this.constraint &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >type.constraint)</span> {
<span class="cstat-no" title="statement not covered" >            return type.constraint.equals(this.constraint);</span>
