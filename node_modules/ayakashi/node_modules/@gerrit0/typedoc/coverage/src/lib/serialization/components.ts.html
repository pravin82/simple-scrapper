...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/serialization/components.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\index.html">All files</a> / <a href="index.html">src/lib/serialization</a> components.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Reflection, Type } from '../models';
...
<span class="cstat-no" title="statement not covered" >    return instance instanceof Reflection;</span>
  }
&nbsp;
  serializeGroupSymbol = Reflection;
}
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  serializeGroup(</span>instance: unknown): boolean {
<span class="cstat-no" title="statement not covered" >    return instance instanceof Type;</span>
  }
&nbsp;
  serializeGroupSymbol = Type;
}
