...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/models/sources/directory.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/models/sources</a> directory.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Reflection } from '../reflections/abstract';
...
&nbsp;
    ...
    constructor(name?: string, parent?: SourceDirectory) {
        if (name &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >parent)</span> {
<span class="cstat-no" title="statement not covered" >            this.name    = name;</span>
<span class="cstat-no" title="statement not covered" >            this.dirName = (parent.dirName ? parent.dirName + '/' : '') + name;</span>
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    toString(</span>indent: string = <span class="branch-0 cbranch-no" title="branch not covered" >'')</span> {
        let res = <span class="cstat-no" title="statement not covered" >indent + this.name;</span>
&nbsp;
        for (let key in this.directories) {
            if (!this.directories.hasOwnProperty(key)) {
<span class="cstat-no" title="statement not covered" >                continue;</span>
            }
<span class="cstat-no" title="statement not covered" >            res += '\n' + this.directories[key].toString(indent + '  ');</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.files.forEach(<span class="fstat-no" title="function not covered" >(f</span>ile) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            res += '\n' + indent + '  ' + file.fileName;</span>
        });
&nbsp;
...
&nbsp;
    ...
    getAllReflections(): Reflection[] {
        ...
        this.files.forEach(<span class="fstat-no" title="function not covered" >(f</span>ile) =&gt; {
<span class="cstat-no" title="statement not covered" >            reflections.push.apply(reflections, file.reflections);</span>
        });
&nbsp;
