...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/output/models/NavigationItem.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/output/models</a> NavigationItem.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Reflection } from '../../models/reflections/abstract';
&nbsp;
/**
...
&nbsp;
        name = name.trim();
        if (name === '') {
<span class="cstat-no" title="statement not covered" >            name = `&lt;em&gt;${reflection.kindString}&lt;/em&gt;`;</span>
        }
&nbsp;
