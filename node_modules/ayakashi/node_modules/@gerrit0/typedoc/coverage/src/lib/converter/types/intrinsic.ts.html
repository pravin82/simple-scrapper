...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/converter/types/intrinsic.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/converter/types</a> intrinsic.ts
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >    throw new Error('Internal TypeScript API missing: TypeFlags.Intrinsic');</span>
}
&nbsp;
