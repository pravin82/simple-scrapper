...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/converter/types/reference.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/converter/types</a> reference.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    convertNode(context: Context, node: ts.TypeReferenceNode, type: ts.TypeReference): Type | undefined {
        if (!type.symbol) {
<span class="cstat-no" title="statement not covered" >            return new IntrinsicType('Object');</span>
        ...
        for (let declaration of symbol.declarations) {
            if (context.visitStack.includes(declaration)) {
                if (declaration.kind === ts.SyntaxKind.TypeLiteral ||
                    ...
                    // TODO: Check if this type assertion is safe and document.
<span class="cstat-no" title="statement not covered" >                    return createReferenceType(context, declaration.symbol!);</span>
                }
            }
        }
&nbsp;
