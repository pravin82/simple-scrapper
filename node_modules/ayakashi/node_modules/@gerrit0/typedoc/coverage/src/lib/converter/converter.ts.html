...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/converter/converter.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\index.html">All files</a> / <a href="index.html">src/lib/converter</a> converter.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">79.63% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>86/108</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>81/102</span>
      </div>
    </div>
    <p class="quiet">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2132x</span>
<span class="cline-any cline-yes">2132x</span>
<span class="cline-any cline-yes">2132x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2122x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2132x</span>
<span class="cline-any cline-yes">2132x</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    removeComponent(</span>name: string): ConverterComponent | undefined {
        const component = <span class="cstat-no" title="statement not covered" >super.removeComponent(name);</span>
        if (component instanceof ConverterNodeComponent) {
<span class="cstat-no" title="statement not covered" >            this.removeNodeConverter(component);</span>
        } else if (component instanceof ConverterTypeComponent) {
<span class="cstat-no" title="statement not covered" >            this.removeTypeConverter(component);</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return component;</span>
    }
&nbsp;
    private <span class="fstat-no" title="function not covered" >removeNodeConverter(</span>converter: ConverterNodeComponent&lt;any&gt;) {
        const converters = <span class="cstat-no" title="statement not covered" >this.nodeConverters;</span>
        const keys = <span class="cstat-no" title="statement not covered" >_.keys(this.nodeConverters);</span>
        for (let key of keys) {
            if (converters[key] === converter) {
<span class="cstat-no" title="statement not covered" >                delete converters[key];</span>
            }
        }
    }
&nbsp;
    private <span class="fstat-no" title="function not covered" >removeTypeConverter(</span>converter: ConverterTypeComponent) {
        const typeIndex = <span class="cstat-no" title="statement not covered" >this.typeTypeConverters.indexOf(&lt;any&gt; converter);</span>
        if (typeIndex !== -1) {
<span class="cstat-no" title="statement not covered" >            this.typeTypeConverters.splice(typeIndex, 1);</span>
        }
&nbsp;
        const nodeIndex = <span class="cstat-no" title="statement not covered" >this.typeNodeConverters.indexOf(&lt;any&gt; converter);</span>
        if (nodeIndex !== -1) {
<span class="cstat-no" title="statement not covered" >            this.typeNodeConverters.splice(nodeIndex, 1);</span>
        }
    }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.nodeConverters = {};</span>
<span class="cstat-no" title="statement not covered" >        this.typeTypeConverters = [];</span>
<span class="cstat-no" title="statement not covered" >        this.typeNodeConverters = [];</span>
    }
&nbsp;
    /**
...
&nbsp;
        ...
        const isRelevantError = <span class="fstat-no" title="function not covered" >({</span> file }: ts.Diagnostic) =&gt; <span class="cstat-no" title="statement not covered" >!file || includedSourceFiles.includes(file);</span>
&nbsp;
