...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/output/themes/DefaultTheme.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/output/themes</a> DefaultTheme.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">81.95% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>109/133</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>106/130</span>
      </div>
    </div>
    <p class="quiet">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">839x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
     ...
     *              otherwise FALSE.
     */
<span class="fstat-no" title="function not covered" >    isOutputDirectory(</span>path: string): boolean {
...
<span class="cstat-no" title="statement not covered" >            entryPoint.url = 'index.html';</span>
<span class="cstat-no" title="statement not covered" >            urls.push(new UrlMapping('index.html', entryPoint, 'reflection.hbs'));</span>
        } else {
...
&nbsp;
    ...
    getEntryPoint(project: ProjectReflection): ContainerReflection {
        ...
        if (entryPoint) {
            const reflection = <span class="cstat-no" title="statement not covered" >project.getChildByName(entryPoint);</span>
            if (reflection) {
                if (reflection instanceof ContainerReflection) {
<span class="cstat-no" title="statement not covered" >                    return reflection;</span>
                } else {
<span class="cstat-no" title="statement not covered" >                    this.application.logger.warn('The given entry point `%s` is not a container.', entryPoint);</span>
                }
            } else {
<span class="cstat-no" title="statement not covered" >                this.application.logger.warn('The entry point `%s` could not be found.', entryPoint);</span>
            }
        }
&nbsp;
        return project;
...
&nbsp;
        ...
        function sortReflections(modules: DeclarationReflection[]) {
            modules.sort((a: DeclarationReflection, b: DeclarationReflection) =&gt; {
                if (a.flags.isExternal &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!b.flags.isExternal)</span> {
...
&nbsp;
        ...
        function includeDedicatedUrls(reflection: DeclarationReflection, item: NavigationItem) {
            (function walk(reflection: DeclarationReflection) {
                for (const child of reflection.children || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span> {
...
&nbsp;
        ...
        function buildChildren(reflection: DeclarationReflection, parent: NavigationItem) {
            ...
            modules.sort(<span class="fstat-no" title="function not covered" >(a</span>: DeclarationReflection, b: DeclarationReflection) =&gt; {
<span class="cstat-no" title="statement not covered" >                return a.getFullName() &lt; b.getFullName() ? -1 : 1;</span>
            });
&nbsp;
...
&nbsp;
            reflections.forEach((reflection) =&gt; {
                if (hasExternals &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!reflection.flags.isExternal </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >state !== 1)</span> {
<span class="cstat-no" title="statement not covered" >                    new NavigationItem('Internals', undefined, parent, 'tsd-is-external');</span>
<span class="cstat-no" title="statement not covered" >                    state = 1;</span>
                } else if (hasExternals &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >reflection.flags.isExternal </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >state !== 2)</span> {
<span class="cstat-no" title="statement not covered" >                    new NavigationItem('Externals', undefined, parent, 'tsd-is-external');</span>
...
&nbsp;
            if (entryPoint === project) {
                const globals = new NavigationItem('Globals', hasSeparateGlobals ? 'globals.html' : <span class="branch-1 cbranch-no" title="branch not covered" >'index.html',</span> root);
...
<span class="cstat-no" title="statement not covered" >                buildGroups(modules, root);</span>
            } else {
...
&nbsp;
    ...
    static buildUrls(reflection: DeclarationReflection, urls: UrlMapping[]): UrlMapping[] {
        ...
        if (mapping) {
            if (!reflection.url || <span class="branch-1 cbranch-no" title="branch not covered" >!DefaultTheme.URL_PREFIX.test(reflection.url))</span> {
...
&nbsp;
            for (const child of reflection.children || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span> {
                if (mapping.isLeaf) {
<span class="cstat-no" title="statement not covered" >                    DefaultTheme.applyAnchorUrl(child, reflection);</span>
                } else {
                    DefaultTheme.buildUrls(child, urls);
                }
            }
...
<span class="cstat-no" title="statement not covered" >                anchor = 'static-' + anchor;</span>
            }
&nbsp;
...
&nbsp;
        ...
        if (reflection.flags.isExternal)  { <span class="cstat-no" title="statement not covered" >classes.push('tsd-is-external'); </span>}
...
&nbsp;
    ...
    static applyGroupClasses(group: ReflectionGroup) {
        ...
        if (group.allChildrenAreExternal)   { <span class="cstat-no" title="statement not covered" >classes.push('tsd-is-external'); </span>}
