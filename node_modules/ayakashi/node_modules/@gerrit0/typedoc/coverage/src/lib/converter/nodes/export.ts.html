...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/converter/nodes/export.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/converter/nodes</a> export.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
        ...
        if (node.symbol &amp;&amp; (node.symbol.flags &amp; ts.SymbolFlags.Alias) === ts.SymbolFlags.Alias) {
            ...
            let type = <span class="cstat-no" title="statement not covered" >context.getTypeAtLocation(node.expression);</span>
<span class="cstat-no" title="statement not covered" >            symbol = type ? type.symbol : undefined;</span>
        }
