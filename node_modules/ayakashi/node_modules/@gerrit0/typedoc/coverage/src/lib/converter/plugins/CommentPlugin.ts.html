...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/converter/plugins/CommentPlugin.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/converter/plugins</a> CommentPlugin.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">78.18% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>86/110</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">78.5% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>84/107</span>
      </div>
    </div>
    <p class="quiet">
...
&nbsp;
        if (this.comments[reflection.id]) {
            ...
            if (!isPreferred &amp;&amp; (<span class="branch-1 cbranch-no" title="branch not covered" >info.isPreferred </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >info.fullText.length &gt; comment.length)</span>) {
...
<span class="cstat-no" title="statement not covered" >            reflection.setFlag(ReflectionFlag.Public);</span>
<span class="cstat-no" title="statement not covered" >            CommentPlugin.removeTags(comment, 'public');</span>
        }
&nbsp;
...
&nbsp;
    ...
    static removeReflection(project: ProjectReflection, reflection: Reflection, deletedIds?: number[]) {
        reflection.traverse(<span class="fstat-no" title="function not covered" >(c</span>hild) =&gt; <span class="cstat-no" title="statement not covered" >CommentPlugin.removeReflection(project, child, deletedIds))</span>;
&nbsp;
            ...
            if (child === reflection) {
                switch (property) {
                    case TraverseProperty.Children:
                        ...
                        break;
<span class="branch-1 cbranch-no" title="branch not covered" >                    case TraverseProperty.GetSignature:</span>
<span class="cstat-no" title="statement not covered" >                        delete parent.getSignature;</span>
<span class="cstat-no" title="statement not covered" >                        break;</span>
<span class="branch-2 cbranch-no" title="branch not covered" >                    case TraverseProperty.IndexSignature:</span>
<span class="cstat-no" title="statement not covered" >                        delete parent.indexSignature;</span>
<span class="cstat-no" title="statement not covered" >                        break;</span>
<span class="branch-3 cbranch-no" title="branch not covered" >                    case TraverseProperty.Parameters:</span>
                        if ((&lt;SignatureReflection&gt; reflection.parent).parameters) {
                            const index = (&lt;SignatureReflection&gt; <span class="cstat-no" title="statement not covered" >reflection.parent).parameters!.indexOf(&lt;ParameterReflection&gt; reflection);</span>
                            if (index !== -1) {
                                (&lt;SignatureReflection&gt; <span class="cstat-no" title="statement not covered" >reflection.parent).parameters!.splice(index, 1);</span>
                            }
                        }
<span class="cstat-no" title="statement not covered" >                        break;</span>
<span class="branch-4 cbranch-no" title="branch not covered" >                    case TraverseProperty.SetSignature:</span>
<span class="cstat-no" title="statement not covered" >                        delete parent.setSignature;</span>
<span class="cstat-no" title="statement not covered" >                        break;</span>
<span class="branch-5 cbranch-no" title="branch not covered" >                    case TraverseProperty.Signatures:</span>
                        if (parent.signatures) {
                            const index = <span class="cstat-no" title="statement not covered" >parent.signatures.indexOf(&lt;SignatureReflection&gt; reflection);</span>
                            if (index !== -1) {
<span class="cstat-no" title="statement not covered" >                                parent.signatures.splice(index, 1);</span>
                            }
                        }
<span class="cstat-no" title="statement not covered" >                        break;</span>
<span class="branch-6 cbranch-no" title="branch not covered" >                    case TraverseProperty.TypeLiteral:</span>
<span class="cstat-no" title="statement not covered" >                        parent.type = new IntrinsicType('Object');</span>
<span class="cstat-no" title="statement not covered" >                        break;</span>
<span class="branch-7 cbranch-no" title="branch not covered" >                    case TraverseProperty.TypeParameter:</span>
                        if (parent.typeParameters) {
                            const index = <span class="cstat-no" title="statement not covered" >parent.typeParameters.indexOf(&lt;TypeParameterReflection&gt; reflection);</span>
                            if (index !== -1) {
<span class="cstat-no" title="statement not covered" >                                parent.typeParameters.splice(index, 1);</span>
                            }
                        }
<span class="cstat-no" title="statement not covered" >                        break;</span>
                }
...
<span class="cstat-no" title="statement not covered" >                    delete project.symbolMapping[key];</span>
                }
            }
        }
&nbsp;
