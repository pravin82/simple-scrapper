...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/utils/fs.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\index.html">All files</a> / <a href="index.html">src/lib/utils</a> fs.ts
    </h1>
    <div class='clearfix'>
...
export function writeFile(fileName: string, data: string, writeByteOrderMark: boolean, onError?: (message: string) =&gt; void) {
    try {
        ...
        if (onError) {
<span class="cstat-no" title="statement not covered" >            onError(e.message);</span>
        }
    }
}
&nbsp;
        ...
        case 0xFE:
            if (buffer[1] === 0xFF) {
                ...
                while ((i + 1) &lt; buffer.length) {
                    const temp = <span class="cstat-no" title="statement not covered" >buffer[i];</span>
<span class="cstat-no" title="statement not covered" >                    buffer[i] = buffer[i + 1];</span>
<span class="cstat-no" title="statement not covered" >                    buffer[i + 1] = temp;</span>
<span class="cstat-no" title="statement not covered" >                    i += 2;</span>
                }
<span class="cstat-no" title="statement not covered" >                return buffer.toString('ucs2', 2);</span>
            }
...
<span class="cstat-no" title="statement not covered" >            break;</span>
        case 0xEF:
            if (buffer[1] === 0xBB) {
<span class="cstat-no" title="statement not covered" >                return buffer.toString('utf8', 3);</span>
            }
    }
&nbsp;
