...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/output/utils/resources/helpers.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/output/utils/resources</a> helpers.ts
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >                this.helpers = file();</span>
            } else {
<span class="cstat-no" title="statement not covered" >                throw new Error('Invalid helper.');</span>
            }
        }
&nbsp;
        return this.helpers;
...
<span class="cstat-no" title="statement not covered" >            Handlebars.unregisterHelper(name);</span>
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        super.removeAllOrigins();</span>
<span class="cstat-no" title="statement not covered" >        this.addCoreHelpers();</span>
    }
}
&nbsp;</pre></td></tr>
</table></pre>
