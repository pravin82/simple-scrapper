...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/models/comments/comment.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/models/comments</a> comment.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { CommentTag } from './tag';
&nbsp;
/**
...
&nbsp;
    ...
    copyFrom(comment: Comment) {
        ...
        this.tags = comment.tags ? <span class="branch-0 cbranch-no" title="branch not covered" >comment.tags.map(<span class="fstat-no" title="function not covered" >(t</span>ag) =&gt; <span class="cstat-no" title="statement not covered" >new CommentTag(tag.tagName, tag.paramName, tag.text))</span> </span>: undefined;
    }
&nbsp;
    /**
