...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/models/reflections/declaration.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/models/reflections</a> declaration.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { DefaultValueContainer, TypeContainer, TypeParameterContainer, TraverseCallback, TraverseProperty } from './abstract';
...
<span class="fstat-no" title="function not covered" >    toString(</span>): string {
        let result = <span class="cstat-no" title="statement not covered" >super.toString();</span>
&nbsp;
        if (this.typeParameters) {
            const parameters: string[] = <span class="cstat-no" title="statement not covered" >[];</span>
<span class="cstat-no" title="statement not covered" >            this.typeParameters.forEach(<span class="fstat-no" title="function not covered" >(p</span>arameter) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                parameters.push(parameter.name);</span>
            });
<span class="cstat-no" title="statement not covered" >            result += '&lt;' + parameters.join(', ') + '&gt;';</span>
        }
&nbsp;
        if (this.type) {
<span class="cstat-no" title="statement not covered" >            result += ':' + this.type.toString();</span>
        }
&nbsp;
