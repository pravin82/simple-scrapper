...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/ts-internal.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\index.html">All files</a> / <a href="index.html">src/lib</a> ts-internal.ts
    </h1>
    <div class='clearfix'>
...
export function <span class="fstat-no" title="function not covered" >createCompilerDiagnostic(</span>) {
<span class="cstat-no" title="statement not covered" >  return tsany.createCompilerDiagnostic.apply(this, arguments);</span>
}
&nbsp;
