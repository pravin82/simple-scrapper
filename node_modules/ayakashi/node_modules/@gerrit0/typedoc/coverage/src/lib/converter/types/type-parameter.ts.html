...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/converter/types/type-parameter.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/converter/types</a> type-parameter.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            return new TypeParameterType(name);</span>
        }
    }
}
&nbsp;</pre></td></tr>
