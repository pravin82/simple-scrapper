...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/converter/nodes/class.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/converter/nodes</a> class.ts
    </h1>
    <div class='clearfix'>
        ...
        context.withScope(reflection, node.typeParameters, () =&gt; {
            if (node.members) {
                node.members.forEach((member) =&gt; {
                    ...
                    const exclude = (context.converter.excludePrivate &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >privateMember)</span>
                        || (context.converter.excludeProtected &amp;&amp; <span class="branch-3 cbranch-no" title="branch not covered" >protectedMember)</span>;
&nbsp;
                    if (!exclude) {
