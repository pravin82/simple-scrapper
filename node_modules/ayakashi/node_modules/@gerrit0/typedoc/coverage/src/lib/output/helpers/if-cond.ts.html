...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/output/helpers/if-cond.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/output/helpers</a> if-cond.ts
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >            return (v1 === v2) ? options.fn(this) : options.inverse(this);</span>
...
<span class="cstat-no" title="statement not covered" >            return (v1 &amp;&amp; v2) ? options.fn(this) : options.inverse(this);</span>
<span class="branch-7 cbranch-no" title="branch not covered" >        case '||':</span>
<span class="cstat-no" title="statement not covered" >            return (v1 || v2) ? options.fn(this) : options.inverse(this);</span>
