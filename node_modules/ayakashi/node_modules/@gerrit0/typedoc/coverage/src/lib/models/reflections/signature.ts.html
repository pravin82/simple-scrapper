...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/models/reflections/signature.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/models/reflections</a> signature.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Type, ReflectionType } from '../types/index';
...
<span class="cstat-no" title="statement not covered" >            this.typeParameters.forEach(<span class="fstat-no" title="function not covered" >(p</span>arameter) =&gt; <span class="cstat-no" title="statement not covered" >parameters.push(parameter.name))</span>;</span>
