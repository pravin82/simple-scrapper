...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/output/renderer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\index.html">All files</a> / <a href="index.html">src/lib/output</a> renderer.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">69.23% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>45/65</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cstat-no" title="statement not covered" >            this.application.logger.error('Could not write %s', page.filename);</span>
<span class="cstat-no" title="statement not covered" >            return false;</span>
        }
&nbsp;
        return true;
    ...
    private prepareTheme(): boolean {
        if (!this.theme) {
            ...
            if (!FS.existsSync(path)) {
                ...
                if (!FS.existsSync(path)) {
<span class="cstat-no" title="statement not covered" >                    this.application.logger.error('The theme %s could not be found.', themeName);</span>
<span class="cstat-no" title="statement not covered" >                    return false;</span>
                }
            }
&nbsp;
            ...
            if (!FS.existsSync(filename)) {
                ...
                try {
                    const themeClass = <span class="cstat-no" title="statement not covered" >typeof require(filename) === 'function' ? require(filename) : require(filename).default;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    this.theme = this.addComponent('theme', new (themeClass)(this, path));</span>
                } catch (err) {
...
<span class="cstat-no" title="statement not covered" >                this.application.logger.error(</span>
...
&nbsp;
            try {
<span class="cstat-no" title="statement not covered" >                FS.removeSync(directory);</span>
            } catch (error) {
<span class="cstat-no" title="statement not covered" >                this.application.logger.warn('Could not empty the output directory.');</span>
            }
        }
&nbsp;
        if (!FS.existsSync(directory)) {
...
<span class="cstat-no" title="statement not covered" >                this.application.logger.error('Could not create output directory %s', directory);</span>
<span class="cstat-no" title="statement not covered" >                return false;</span>
            }
        }
&nbsp;
