...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/converter/types/string-literal.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/converter/types</a> string-literal.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    convertNode(</span>context: Context, node: ts.StringLiteral): Type {
<span class="cstat-no" title="statement not covered" >        return new StringLiteralType(node.text);</span>
    }
&nbsp;
    /**
