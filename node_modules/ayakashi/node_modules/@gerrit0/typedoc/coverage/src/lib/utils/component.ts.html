...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/utils/component.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\index.html">All files</a> / <a href="index.html">src/lib/utils</a> component.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">79.37% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>50/63</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-yes">33x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4506x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">6757x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3846x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >            throw new Error('The `Component` decorator can only be used with a subclass of `AbstractComponent`.');</span>
        }
&nbsp;
        if (options.childClass) {
            if (!(proto instanceof ChildableComponent)) {
<span class="cstat-no" title="statement not covered" >                throw new Error('The `Component` decorator accepts the parameter `childClass` only when used with a subclass of `ChildableComponent`.');</span>
            }
&nbsp;
            childMappings.push({
                host: proto,
...
<span class="cstat-no" title="statement not covered" >            throw new Error('The `Option` decorator can only be used on properties within an `AbstractComponent` subclass.');</span>
        }
&nbsp;
...
&nbsp;
    ...
    get application(): Application {
        return this._componentOwner === DUMMY_APPLICATION_OWNER
            ? <span class="branch-0 cbranch-no" title="branch not covered" >this as any as Application</span>
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    getComponent(</span>name: string): C | undefined {
<span class="cstat-no" title="statement not covered" >        return (this._componentChildren || {})[name];</span>
    }
&nbsp;
    getComponents(): C[] {
...
&nbsp;
<span class="fstat-no" title="function not covered" >    hasComponent(</span>name: string): boolean {
<span class="cstat-no" title="statement not covered" >        return !!(this._componentChildren || {})[name];</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            return &lt;T&gt; this._componentChildren[name];</span>
        } else {
...
&nbsp;
<span class="fstat-no" title="function not covered" >    removeComponent(</span>name: string): C | undefined {
        const component = <span class="cstat-no" title="statement not covered" >(this._componentChildren || {})[name];</span>
        if (component) {
<span class="cstat-no" title="statement not covered" >            delete this._componentChildren![name];</span>
<span class="cstat-no" title="statement not covered" >            component.stopListening();</span>
<span class="cstat-no" title="statement not covered" >            this.bubble(new ComponentEvent(ComponentEvent.REMOVED, this, component));</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        this._componentChildren = {};</span>
    }
}
&nbsp;</pre></td></tr>
</table></pre>
