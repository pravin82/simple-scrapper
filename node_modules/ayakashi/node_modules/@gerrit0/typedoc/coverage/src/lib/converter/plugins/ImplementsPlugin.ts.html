...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/converter/plugins/ImplementsPlugin.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/converter/plugins</a> ImplementsPlugin.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Reflection, ReflectionKind, DeclarationReflection, SignatureReflection } from '../../models/reflections/index';
...
&nbsp;
            if (interfaceMember.kindOf(ReflectionKind.FunctionOrMethod) &amp;&amp; interfaceMember.signatures &amp;&amp; classMember.signatures) {
                interfaceMember.signatures.forEach((interfaceSignature: SignatureReflection) =&gt; {
                    ...
                    (classMember!.signatures || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>.forEach((classSignature: SignatureReflection) =&gt; {
...
<span class="branch-2 cbranch-no" title="branch not covered" >                source instanceof SignatureReflection </span>&amp;&amp; <span class="branch-3 cbranch-no" title="branch not covered" >source.parameters)</span> {
                for (let index = <span class="cstat-no" title="statement not covered" >0,</span> count = <span class="cstat-no" title="statement not covered" >target.parameters.length;</span> index &lt; count; index++) {
                    if (target.parameters[index].comment) {
<span class="cstat-no" title="statement not covered" >                        target.parameters[index].comment!.copyFrom(source.parameters[index].comment!);</span>
                    }
                }
            }
        }
