...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/utils/plugins.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\index.html">All files</a> / <a href="index.html">src/lib/utils</a> plugins.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1100x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">7875x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >                logger.error('Unknown plugin %s', plugin);</span>
        ...
        for (i = 0; i &lt; c; i++) {
            ...
            try {
                ...
                const initFunction = typeof instance.load === 'function'
                    ? <span class="branch-0 cbranch-no" title="branch not covered" >instance.load</span>
...
<span class="cstat-no" title="statement not covered" >                    logger.error('Invalid structure in plugin %s, no function found.', plugin);</span>
                }
            } catch (error) {
<span class="cstat-no" title="statement not covered" >                logger.error('The plugin %s could not be loaded.', plugin);</span>
<span class="cstat-no" title="statement not covered" >                logger.writeln(error.stack);</span>
<span class="cstat-no" title="statement not covered" >                return false;</span>
            }
        }
        return true;
...
&nbsp;
                ...
                if (isPlugin(info)) {
<span class="cstat-no" title="statement not covered" >                    result.push(Path.join(basePath, name));</span>
                }
            });
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                logger.error('Could not parse %s', fileName);</span>
