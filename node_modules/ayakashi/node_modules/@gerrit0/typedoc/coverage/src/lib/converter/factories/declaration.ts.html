...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/converter/factories/declaration.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/converter/factories</a> declaration.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">791x</span>
<span class="cline-any cline-yes">791x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >        throw new Error('Expected container reflection.');</span>
    }
...
&nbsp;
    if (
        ...
        if (!reflection.inheritedFrom) {
            ...
            reflection.getAllSignatures().forEach(<span class="fstat-no" title="function not covered" >(s</span>ignature) =&gt; {
<span class="cstat-no" title="statement not covered" >                signature.inheritedFrom = createReferenceType(context, node.symbol, true);</span>
            });
        }
    }
&nbsp;
...
&nbsp;
    if (
        context.isInherit &amp;&amp;
        (context.inherited || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>.includes(reflection.name) &amp;&amp;
        (node.parent === context.inheritParent || reflection.flags.isConstructorProperty)
    ) {
