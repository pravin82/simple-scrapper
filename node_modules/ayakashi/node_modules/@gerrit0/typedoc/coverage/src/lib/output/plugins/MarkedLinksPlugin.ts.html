...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/output/plugins/MarkedLinksPlugin.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/output/plugins</a> MarkedLinksPlugin.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import * as Util from 'util';
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                reflection = this.project.findReflectionByName(target);</span>
            }
&nbsp;
            if (reflection &amp;&amp; reflection.url) {
                if (this.urlPrefix.test(reflection.url)) {
<span class="cstat-no" title="statement not covered" >                    target = reflection.url;</span>
<span class="cstat-no" title="statement not covered" >                    attributes = ' class="external"';</span>
                } else {
                    target = this.getRelativeUrl(reflection.url);
                }
            } else {
                const fullName = (this.reflection || <span class="branch-1 cbranch-no" title="branch not covered" >this.project)</span>!.getFullName();
...
&nbsp;
    ...
    onEndRenderer(event: RendererEvent) {
        if (this.listInvalidSymbolLinks &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.warnings.length &gt; 0)</span> {
<span class="cstat-no" title="statement not covered" >            this.application.logger.write('');</span>
<span class="cstat-no" title="statement not covered" >            this.application.logger.warn('[MarkedLinksPlugin]: Found invalid symbol reference(s) in JSDocs, ' +</span>
                'they will not render as links in the generated documentation.');
&nbsp;
            for (let warning of this.warnings) {
<span class="cstat-no" title="statement not covered" >                this.application.logger.write('  ' + warning);</span>
            }
        }
    }
&nbsp;
