...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/converter/utils/base-path.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/converter/utils</a> base-path.ts
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >                    continue basePaths;</span>
                } else {
                    // Partial match, trim the known base path
                    if (m &lt; basePath.length) {
<span class="cstat-no" title="statement not covered" >                        this.basePaths[n] = basePath.slice(0, m).join('/');</span>
                    }
