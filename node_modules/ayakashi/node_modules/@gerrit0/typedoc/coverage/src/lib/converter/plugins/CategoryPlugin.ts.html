...
<html lang="en">
<head>
    <title>Code coverage report for src/lib/converter/plugins/CategoryPlugin.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">src/lib/converter/plugins</a> CategoryPlugin.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Reflection, ContainerReflection, DeclarationReflection } from '../../models';
...
<span class="cstat-no" title="statement not covered" >            CategoryPlugin.WEIGHTS = this.categoryOrder;</span>
        }
    }
&nbsp;
    /**
...
&nbsp;
    ...
    static getReflectionCategories(reflections: Reflection[]): ReflectionCategory[] {
        ...
        reflections.forEach((child) =&gt; {
            ...
            if (childCat === '') {
                if (!defaultCat) {
                    defaultCat = categories.find(<span class="fstat-no" title="function not covered" >category </span>=&gt; <span class="cstat-no" title="statement not covered" >category.title === CategoryPlugin.defaultCategory)</span>;
                    if (!defaultCat) {
...
&nbsp;
    ...
    static sortCatCallback(a: ReflectionCategory, b: ReflectionCategory): number {
        ...
        if (aWeight === -1 || <span class="branch-1 cbranch-no" title="branch not covered" >bWeight === -1)</span> {
        ...
        if (aWeight === bWeight) {
            return a.title &gt; b.title ? <span class="branch-0 cbranch-no" title="branch not covered" >1 </span>: -1;
        }
<span class="cstat-no" title="statement not covered" >        return aWeight - bWeight;</span>
    }
}
&nbsp;</pre></td></tr>
</table></pre>
