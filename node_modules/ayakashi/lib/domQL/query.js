...
function runQuery(env, query, el) {
    ...
    if (Array.isArray(query.where[top])) {
        ...
        reductionTree[top] = [];
        if (top !== "and" && top !== "or") {
            throw new Error(`Invalid operator: ${top}. Learn more at https://ayakashi.io/docs/guide/querying-with-domql.html`);
        }
        ...
        if (!operators_1.operators[op]) {
            throw new Error(`Invalid operator: ${op}. Learn more at https://ayakashi.io/docs/guide/querying-with-domql.html`);
        }
...
reductionTree, el, top) {
    if (Array.isArray(member[key])) {
        ...
        if (newTop !== "and" && newTop !== "or") {
            throw new Error(`Invalid operator: ${newTop}. Learn more at https://ayakashi.io/docs/guide/querying-with-domql.html`);
        }
        const container = { [key]: [] };
...
function throwIfInvalidExpected(expected) {
    if (!expected ||
        ...
        throw new Error(`Invalid expected value: ${Array.isArray(expected) ||
            ...
            ? JSON.stringify(expected) : String(expected) || "empty_string"}. Learn more at https://ayakashi.io/docs/guide/querying-with-domql.html`);
    }
}
